...
public class abaAdicionar extends JFrame {

    public abaAdicionar() {

        super("FINANCEIRO-ADICIONAR");
        setResizable(false);
        setSize(700, 600);
        ...
        codigo.addFocusListener(new FocusAdapter() {
            public void focusGained(FocusEvent e) {
                if (codigo.getText().equals("CÓDIGO")) {
                    codigo.setText("");
                    codigo.setForeground(Color.BLACK);  // Texto normal
                }
            }
        ...
        JButton adicionar = new JButton("ENTRADA");
        ...
        JButton vender = new JButton("SAIDA");
