...
public class abaEditarCliente extends JFrame {

    public abaEditarCliente() {
        ...
        cpf.setBounds(100, 160, 500, 50);
        cpf.setFont(new Font("Tahoma", Font.BOLD, 12));
        ...
        endereco.setBounds(100, 240, 500, 50);
        ...
        telefone.setBounds(100, 320, 500, 50);
        ...
        email.setBounds(100, 400, 500, 50);
